...
describe Product do
  context "when products have comments" do
    ...
    before do
      ...
      @product.comments.create!(rating: 1, user: @user, body: "Just ok really!")
      @product.comments.create!(rating: 3, user: @user, body: "Just ok really!")
      @product.comments.create!(rating: 5, user: @user, body: "Just ok really!")
    end
